...
const InterviewSetup = ({ onStartInterview, onBack }: InterviewSetupProps) => {
  ...
  ,{ id: 'upsc', name: 'UPSC', icon: Brain, description: 'Civil services interview preparation' }
  ];
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <Card>
                ...
                <CardContent>
                  <Select value={config.role} onValueChange={(value) => setConfig(prev => ({ ...prev, role: value, type: value === 'UPSC' ? 'upsc' : prev.type }))}>
                    <SelectTrigger>
              ...
              <Card>
                ...
                <CardContent>
                  <Select value={String(config.questionCount)} onValueChange={(value) => setConfig(prev => ({ ...prev, questionCount: Number(value) }))}>
                    <SelectTrigger>
